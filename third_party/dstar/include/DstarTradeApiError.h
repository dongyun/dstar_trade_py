...
const DstarApiErrorCodeType DSTAR_API_ERR_SEND              = 10005;    // 数据发送错误
const DstarApiErrorCodeType DSTAR_API_ERR_RECV              = 10006;    // 数据接收错误
const DstarApiErrorCodeType DSATR_API_ERR_DATA_PROCESS      = 10007;    // 数据解析错误
const DstarApiErrorCodeType DSATR_API_ERR_BUFF_OVERFLOW     = 10008;    // 缓冲区溢出错误
const DstarApiErrorCodeType DSATR_API_ERR_HB_TIMEOUT        = 10009;    // 心跳超时错误
...
const DstarApiErrorCodeType DSTAR_API_ERR_MESSAGEAMOUNT     = 20041;    // 信息量超限
const DstarApiErrorCodeType DSTAR_API_ERR_OFFERQTY          = 20042;    // 报价单买卖方向数据不一致
const DstarApiErrorCodeType DSTAR_API_ERR_ORDERIDREPLACE    = 20043;    // 顶单委托号不存在
const DstarApiErrorCodeType DSTAR_API_ERR_SYSNOREPLACE      = 20044;    // 顶单系统号不存在
const DstarApiErrorCodeType DSTAR_API_ERR_SYSTEMTYPE        = 20045;    // 备份系统未激活
const DstarApiErrorCodeType DSTAR_API_ERR_UDPADDR           = 20046;    // udp包地址非法
const DstarApiErrorCodeType DSTAR_API_ERR_SELFMATCH         = 20047;    // 可能自成交
const DstarApiErrorCodeType DSTAR_API_ERR_CASHINOUTVALUE    = 20048;    // 出入金金额非法
const DstarApiErrorCodeType DSTAR_API_ERR_CASHOUTMORE       = 20049;    // 出金金额大于可用
const DstarApiErrorCodeType DSTAR_API_ERR_APPLICATIONNO     = 20050;    // 应用程序号异常
const DstarApiErrorCodeType DSTAR_API_ERR_ACCLICENSENO      = 20051;    // 客户未授权该授权码
const DstarApiErrorCodeType DSTAR_API_ERR_LICENSENODATE     = 20052;    // 授权码到期
const DstarApiErrorCodeType DSTAR_API_ERR_LOGINRIGHT        = 20053;    // 禁止登录
...
const DstarApiErrorCodeType DSTAR_API_ERR_CANCEL_ABANDON    = 30008;    // 不支持撤销弃权定单
...
const DstarApiErrorCodeType DSTAR_API_ERR_CANCEL_ENQUIRY    = 30012;    // 不支持撤销询价订单
